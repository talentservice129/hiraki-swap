  ...
  return (
    <StyledContainer>
      ...
      <Box position={"relative"} zIndex={10}>
        <Content>We allow your token pools to be utilized and to prevent slippage in your chart price for your seller, buyers, and large traders.</Content>
        <Content>
          Apply for Hikari Pools{" "}
          <Link href={"https://hikari-swap.vercel.app/"} target={"_blank"} style={{ textDecoration: "none", color: "#0093C1" }}>
            here
          </Link>
        </Content>
      </Box>
...
const Background = styled(Box)`
  background-image: url("/images/partnerships_back.png");
